...
void glm_vec2_refract(vec2 v, vec2 n, float eta, vec2 dest);
...
void glm_vec3_refract(vec3 v, vec3 n, float eta, vec3 dest);
...
void glm_vec4_refract(vec4 v, vec4 n, float eta, vec4 dest);
